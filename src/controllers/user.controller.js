...
const registerUser = asyncHandler(async (req, res) => {
    ...
    */
    ...
    const existedUser = await User.findOne({  //checks if usernme or email already exists
        $or: [{ username }, { email }]
    })
    if (existedUser) {
...
const logoutUser = asyncHandler(async (req, res) => {  // remove cookies and tokens
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    //TODO: delete old image/avatar - utiity funtion
    ...
    return res.status(200)
        .json(
            new ApiError(200, user, "Avatar updated succesfully")
        )
})
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    return res.status(200)
        .json(
            new ApiError(200, user, "Cover image updated succesfully")
        )
})
